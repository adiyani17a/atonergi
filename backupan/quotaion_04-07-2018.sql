...
-- Dumping data for table atonergi.d_quotation: ~2 rows (approximately)
DELETE FROM `d_quotation`;
/*!40000 ALTER TABLE `d_quotation` DISABLE KEYS */;
INSERT INTO `d_quotation` (`q_id`, `q_nota`, `q_subtotal`, `q_tax`, `q_total`, `q_dp`, `q_remain`, `q_customer`, `q_address`, `q_type`, `q_type_product`, `q_shipping_method`, `q_date`, `q_term`, `q_delivery`, `q_ship_to`, `q_marketing`, `q_status`, `q_created_at`, `q_updated_at`, `q_update_by`) VALUES
	...
	(3, 'QO-003/SWP/PSG-002/072018', 17075000, 0, 17075000, 0, 0, 'MKT/00001', 'jl.asd', 'SWP', 'PSG-002', 'Sea', '2018-07-04', 'sss', '2018-07-28', 'sss', '2', 1, '2018-07-04 13:54:28', '2018-07-04 14:16:45', 'admin');
...
-- Dumping data for table atonergi.d_quotation_dt: ~2 rows (approximately)
...
INSERT INTO `d_quotation_dt` (`qd_id`, `qd_dt`, `qd_item`, `qd_qty`, `qd_description`, `qd_price`, `qd_total`, `qd_update_by`) VALUES
	...
	(3, 2, 'BRG/0001', 2, 'xx', 5000000, 10000000, 'admin'),
	(3, 3, 'BRG/0004', 5, 'xx', 15000, 75000, 'admin');
...
-- Dumping data for table atonergi.m_item: ~6 rows (approximately)
DELETE FROM `m_item`;
/*!40000 ALTER TABLE `m_item` DISABLE KEYS */;
INSERT INTO `m_item` (`i_id`, `i_code`, `i_name`, `i_unit`, `i_price`, `i_sell_price`, `i_lower_price`, `i_active`, `i_jenis`, `i_type`, `i_minstock`, `i_image`, `i_weight`, `i_description`, `i_insert_at`, `i_update_at`, `i_insert_by`, `i_update_by`) VALUES
...
-- Dumping data for table atonergi.m_item_dt: ~3 rows (approximately)
DELETE FROM `m_item_dt`;
/*!40000 ALTER TABLE `m_item_dt` DISABLE KEYS */;
INSERT INTO `m_item_dt` (`id_id`, `id_detailid`, `id_item`, `id_unit`, `id_qty`, `id_price_unit`, `id_total_price`, `id_insert_at`, `id_update_at`, `id_insert_by`, `id_update_by`) VALUES
