...
@include('projectmp.pmp_dokumentasi.tambah_dokumentasi')
...
<div class="content-wrapper">
	<div class="col-lg-12">	
		<nav aria-label="breadcrumb" role="navigation">
			<ol class="breadcrumb bg-info">
				...
				<li class="breadcrumb-item"><a href="{{url('project/pilih_dokumentasi/pilih_dokumentasi')}}">Dokumentasi</a></li>
				<li class="breadcrumb-item active" aria-current="page">Dokumentasi Pompa</li>
			</ol>
		</nav>
	</div>
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Dokumentasi Pompa</h4>
