...
@include('projectmp.pmp_pengepakanbarang.tambah_pengepakan')
...
<div class="content-wrapper">
	<div class="col-lg-12">	
		<nav aria-label="breadcrumb" role="navigation">
			<ol class="breadcrumb bg-info">
				...
				<li class="breadcrumb-item"><a href="{{url('project/pilih_pengepakanbarang/pilih_pengepakanbarang')}}">Pengepakan Barang</a></li>
				<li class="breadcrumb-item active" aria-current="page">Pengepakan Barang Pompa</li>
			</ol>
		</nav>
	</div>
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pengepakan Barang Pompa</h4>
