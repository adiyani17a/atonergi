...
@include('projectmp.pmp_pemasangan.tambah_pemasangan')
...
<div class="content-wrapper">
	<div class="col-lg-12">	
		<nav aria-label="breadcrumb" role="navigation">
			<ol class="breadcrumb bg-info">
				...
				<li class="breadcrumb-item"><a href="{{url('project/pilih_pemasangan/pilih_pemasangan')}}">Pemasangan</a></li>
				<li class="breadcrumb-item active" aria-current="page">Pemasangan Pompa</li>
			</ol>
		</nav>
	</div>
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pemasangan Pompa</h4>
