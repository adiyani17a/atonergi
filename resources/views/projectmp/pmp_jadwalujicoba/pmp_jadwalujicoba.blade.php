...
@include('projectmp.pmp_jadwalujicoba.tambah_jadwal')
...
<div class="content-wrapper">
	<div class="col-lg-12">	
		<nav aria-label="breadcrumb" role="navigation">
			<ol class="breadcrumb bg-info">
				...
				<li class="breadcrumb-item"><a href="{{url('project/pilih_jadwalujicoba/pilih_jadwalujicoba')}}">Schedule Uji Coba</a></li>
				<li class="breadcrumb-item active" aria-current="page">Schedule Uji Coba Pompa</li>
			</ol>
		</nav>
	</div>
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Schedule Uji Coba Pompa</h4>
