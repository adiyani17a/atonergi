...
@include('projectms/shs_pengirimanbarang/shs_editpengirimanbarang')
...
<div class="content-wrapper">
	<div class="col-lg-12">	
		<nav aria-label="breadcrumb" role="navigation">
			<ol class="breadcrumb bg-info">
				...
				<li class="breadcrumb-item active" aria-current="page">Pengiriman Barang SHS</li>
			</ol>
		</nav>
	</div>
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Pengiriman Barang SHS</h4>
	                  ...
	                  <table class="table data-table table-hover" cellspacing="0">
	                  	...
	                  	<tbody>
	                  		...
	                  		<tr>
	                  			...
	                  			<td>
	                  				<div class="btn-group">
	                  					<a href="{{url('projectms/shs_pengirimanbarang/shs_prosespengirimanbarang')}}" class="btn btn-info btn-sm" title="Process"><i class="fa fa-sign-in"></i></a>
	                  					<button class="btn btn-danger btn-sm" type="button" title="Delete"><i class="fa fa-trash-o"></i></button>
	                  				</div>
	                  			</td>
	                  		</tr>
