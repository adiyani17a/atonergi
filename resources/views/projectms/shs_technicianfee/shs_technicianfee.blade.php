...
@include('projectms.shs_technicianfee.tambah_technician')
...
<div class="content-wrapper">
	<div class="col-lg-12">	
		<nav aria-label="breadcrumb" role="navigation">
			<ol class="breadcrumb bg-info">
				...
				<li class="breadcrumb-item"><a href="{{url('project/pilih_technicianfee/pilih_technicianfee')}}">Technician Fee</a></li>
				<li class="breadcrumb-item active" aria-current="page">Technician Fee SHS</li>
			</ol>
		</nav>
	</div>
	<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Technician Fee SHS</h4>
