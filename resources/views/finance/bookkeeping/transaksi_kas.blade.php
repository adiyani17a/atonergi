...
@include('finance/bookkeeping/list_transaksi_kas')
<!-- partial -->
<div class="content-wrapper">
	<div class="row">
		<div class="col-lg-12">	
			<nav aria-label="breadcrumb" role="navigation">
				<ol class="breadcrumb bg-info">
					...
					<li class="breadcrumb-item active" aria-current="page">Transaksi Kas</li>
				</ol>
			</nav>
		</div>
		<div class="col-lg-12 grid-margin stretch-card">
	      	<div class="card">
		        <div class="card-body">
		          <h4 class="card-title">Transaksi Kas</h4>
		          	<div class="row">
			            ...
			            <div class="col-md-6 col-sm-12 col-xs-12">
			              <div class="form-group">
			                <select class="form-control form-control-sm" id="">
			                  ...
			                  <option value="inn">Kas Masuk</option>
			                </select>
			              </div>
			            </div>
			            <div class=" col-md-3 col-sm-12 alamraya-no-padding">
							<span class="input-group-append">
								<button type="button" class="btn btn-primary btn-sm icon-btn ml-2" title="Lihat Daftar Data Transaksi" data-toggle="modal" data-target="#lihatkas">
