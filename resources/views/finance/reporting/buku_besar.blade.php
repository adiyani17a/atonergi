<!-- Modal -->
<div id="bukubesar" class="modal fade" role="dialog">
  <div class="modal-dialog">

    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header bg-gradient-info">
        <h4 class="modal-title">Setting Buku Besar</h4>
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <label>Pilih Akun 1</label>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <select class="form-control form-control-sm" id="filter">
                  <option disabled selected>--Pilih--</option>
                  <option value="kas">100.01 - Kas Besar</option>
                  <option value="kas">100.02 - Kas Kecil</option>
                </select>
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <label>s/d Akun</label>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <select class="form-control form-control-sm" id="filter">
