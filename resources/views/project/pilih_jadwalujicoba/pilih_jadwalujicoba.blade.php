            ...
            <div class="row">
	            	<div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-primary text-white">
            			<a href="{{url('projectmp/pmp_jadwalujicoba/pmp_jadwalujicoba')}}" class="text-white pilih-link">
			                <div class="card-body">
			                  <h1 class="font-weight-normal mb-3"><i class="mdi mdi-engine"></i></h1>
			                  <p class="card-text">Schedule Uji Coba</p>
		            ...
		            <div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-success text-white">
		        		<a href="{{url('projectms/shs_jadwalujicoba/shs_jadwalujicoba')}}" class="text-white pilih-link">
			                <div class="card-body">
