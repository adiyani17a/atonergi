	                  ...
	                  <table class="table data-table table-hover" cellspacing="0">
	                  	...
	                  	<tbody>
	                  		<tr>
	                  			...
	                  			<td>
	                  				<div class="btn-group">
	                  					<button class="btn btn-danger btn-sm" disabled="" type="button" title="Delete"><i class="fa fa-trash"></i></button>
	                  				</div>
	                  			</td>
	                  		</tr>
	                  		<tr>
	                  			...
	                  			<td>
	                  				<div class="btn-group">
	                  					<button data-target="#edit" data-toggle="modal" data class="btn btn-warning btn-sm" title="Edit"><i class="fa fa-pencil-alt"></i></button>
	                  		...
	                  		<tr>
	                  			...
	                  			<td>
	                  				<div class="btn-group">
	                  					<a href="{{url('project/pengirimanbarang/prosespengirimanbarang')}}" class="btn btn-info btn-sm" title="Process"><i class="fa fa-sign-in-alt"></i></a>
	                  					<button class="btn btn-danger btn-sm" type="button" title="Delete"><i class="fa fa-trash"></i></button>
	                  				</div>
	                  			</td>
	                  		</tr>
