            ...
            <div class="row">
	            	<div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-primary text-white">
            			<a href="{{url('projectmp/pmp_dokumentasi/pmp_dokumentasi')}}" class="text-white pilih-link">
			                <div class="card-body">
		            ...
		            <div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-success text-white">
		        		<a href="{{url('projectms/shs_dokumentasi/shs_dokumentasi')}}" class="text-white pilih-link">
			                <div class="card-body">
