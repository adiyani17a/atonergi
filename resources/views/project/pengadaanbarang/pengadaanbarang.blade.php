...
@include('project.pengadaanbarang.tambah_pengadaan')

@include('project.pengadaanbarang.detail_pengadaanbarang')
<!-- partial -->
		                  ...
		                  <table class="table data-table table-hover" cellspacing="0" id="chieftain_mk3">
		                  	...
		                  	<tbody>
		                  		<tr>
		                  			...
		                  			<td>B001</td>
		                  			<td>Alpha</td>
		                  			<td><button class="btn btn-sm btn-outline-primary" type="button" data-toggle="modal" data-target="#detail_item">Detail</button></td>
		                  			<td>
		                  				<span class="badge badge-pill badge-success">Check</span>
		                  			</td>
		                  			<td>
		                  				<div class="btn-group">
		                  					<a class="btn btn-info btn-sm" href="{{url('project/pengadaanbarang/prosespengadaanbarang')}}" title="Process"><i class="fa fa-sign-in-alt"></i></a>
