		...
		<div class="col-lg-12">	
			<nav aria-label="breadcrumb" role="navigation">
				<ol class="breadcrumb bg-info">
					...
					<li class="breadcrumb-item active" aria-current="page">Sales Common</li>
				</ol>
			</nav>
		</div>
	</div>
            <div class="row">
	            	<div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-primary text-white">
            			<a href="{{url('projectmp/pmp_salescommon/pmp_salescommon')}}" class="text-white pilih-link">
			                <div class="card-body">
			                  <h1 class="font-weight-normal mb-3"><i class="mdi mdi-engine"></i></h1>
			                  <p class="card-text">Sales Common</p>
		            ...
		            <div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-success text-white">
		        		<a href="{{url('projectms/shs_salescommon/shs_salescommon')}}" class="text-white pilih-link">
			                <div class="card-body">
