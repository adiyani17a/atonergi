		...
		<div class="col-lg-12">	
			<nav aria-label="breadcrumb" role="navigation">
				<ol class="breadcrumb bg-info">
					...
					<li class="breadcrumb-item active" aria-current="page">Technician Fee</li>
				</ol>
			</nav>
		</div>
	</div>
            <div class="row">
	            	<div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-primary text-white">
            			<a href="{{url('projectmp/pmp_technicianfee/pmp_technicianfee')}}" class="text-white pilih-link">
			                <div class="card-body">
			                  <h1 class="font-weight-normal mb-3"><i class="mdi mdi-engine"></i></h1>
			                  <p class="card-text">Technician Fee</p>
		            ...
		            <div class="col-md-6 col-sm-6 col-xs-12 stretch-card grid-margin">
		              <div class="card bg-gradient-success text-white">
		        		<a href="{{url('projectms/shs_technicianfee/shs_technicianfee')}}" class="text-white pilih-link">
			                <div class="card-body">
