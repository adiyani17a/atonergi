    ...
    public function barangproses(Request $request)
    {
        ...
        return DB::transaction(function() use ($request) {  
            ...
            $save = DB::table('m_item')->insert([
                ...
                'i_unit'        =>  $request->unit,
                'i_price'       =>  filter_Var($request->price,FILTER_SANITIZE_NUMBER_FLOAT),
                'i_sell_price'  =>  filter_Var($request->sell_price,FILTER_SANITIZE_NUMBER_FLOAT),
                'i_lower_price' =>  filter_Var($request->lower_price,FILTER_SANITIZE_NUMBER_FLOAT),
                'i_active'      =>  'Y',
                'i_jenis'       =>  'ITEM',
